...
ai2 = opp.Strategy()  ## make this different to play 2 different strategy files
...
def tournament_player(black_choice, white_choice, black_name="Black", white_name="White", time_limit=5):
    ...
    for i in range(2*rounds):
        try:
            ...
            print(e)
            return
    print("strategy A won", ai1_wins, "out of", 4*rounds)
    return ai1_wins
...
def play(black_strategy, white_strategy, black_name, white_name, time_limit=60):
    ...
    black_score = ai1.score2(core.BLACK, board)
    if black_score > 0:
        winner = black_name
    elif black_score < 0:
        winner = white_name
    ...
    return board, ai1.score2(core.BLACK, board)
